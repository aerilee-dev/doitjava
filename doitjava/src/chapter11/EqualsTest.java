...
public class EqualsTest {
	public static void main(String[] args) {
		...
		if (studentLee == studentLee2)
			System.out.println("studentLee 와 student2의 주소는 같습니다.");
		else
			System.out.println("studentLee 와 student2의 주소는 다릅니다");

		if (studentLee.equals(studentLee2))
			System.out.println("studentLee 와 student2는 동일합니다.");
		else
			System.out.println("studentLee 와 student2는 동일하지 않습니다.");
